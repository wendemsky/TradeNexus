...
public class TradeController {
	...
	@PostMapping(value="/suggest-buy", 
				consumes={ MediaType.APPLICATION_JSON_VALUE},
				produces={ MediaType.APPLICATION_JSON_VALUE})
	public ResponseEntity<List<Price>> getRoboAdvisorTopBuyInstruments(@RequestBody ClientPreferences clientPreferences){
	...
	public ResponseEntity<List<Price>> getRoboAdvisorTopSellInstruments(@RequestBody ClientPreferences clienPreferences){
		ResponseEntity<List<Price>> response = null;
		try {
