...
describe('PriceListComponent', () => {
  ...
  beforeEach(async () => {
    priceMockService = jasmine.createSpyObj('PriceService', ['getPricesFromFIPS','setLivePrices'])
    getLivePricesSpy = priceMockService.getPricesFromFIPS.and.returnValue(of(mockPrices))
