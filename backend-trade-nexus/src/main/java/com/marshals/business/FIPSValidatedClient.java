...
public class FIPSValidatedClient {
	private String clientId;
	private String email;
	private Integer token;
	public FIPSValidatedClient() {}
	public FIPSValidatedClient(String clientId, String email, Integer token) {
		try {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FIPSValidatedClient other = (FIPSValidatedClient) obj;
		return Objects.equals(clientId, other.clientId) && Objects.equals(email, other.email)
				&& Objects.equals(token, other.token);
	}
	@Override
	public String toString() {
		return "FIPSValidatedClient [clientId=" + clientId + ", email=" + email + ", token=" + token + "]";
	}
